...
-- procedimiento para iniciar sesión (solo usuarios activos con credenciales correctas)
delimiter $$
...
-- procedimiento para buscar un usuario por username (activo o no) lo usan el login (T1.8) y la validación de username repetido
...
call sp_buscarusuarioporusername('draguay');
